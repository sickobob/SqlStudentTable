...
namespace WinFormsApp2
{
    public partial class Form2 : Form
    {
        public Form2(string role,string login)
        {
            ...
            Role = role;
            Login = login;
            form3 = new Form3(role);
            form4 = new Form4();
        }
 
       const string connectionString = @"Server=emiit.ru;Database=tereshkin_epb211;User Id=user-96;Password=Baf62932;TrustServerCertificate=True";
        static string Role;
        static string Login;
        Form3 form3;
        Form4 form4;
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            dataTable.Columns.Add("№ Студенческого ", typeof(int));
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            Text = $"Терешкин Алексей Александрович ЭПБ-211 {Login}, {Role}";
        }
